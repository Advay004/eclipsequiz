# -*- coding: utf-8 -*-
"""
Created on Sun Oct  8 21:18:29 2023
        ...
        for event in pygame.event.get():
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_n:
                    current_question += 1
                    answer_checked = False  # Reset answer_checked to allow answering the next question
                    selected_option = None  # Reset selected_option as well
